...
OpenQuery is designed with information security in mind, and ships with effective data masking techniques for both your database schema and your natural language queries.
