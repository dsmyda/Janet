...
OpenQuery is an open source library that automates the most mundane analytics questions. It works by synthesizing your database schema, generating and running candidate queries against your database.
